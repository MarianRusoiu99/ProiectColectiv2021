...
TheTaskDispatcherApp
 ...
 <div style="margin-top: 50px;" align="center" class="wrapper fadeInDown">
  <div id="formContent">
    ...
    <tr>
     <td style="text-align:right;padding-right:10px;">Job</td>
     <td><input type="text" class="fadeIn second" name="job" /></td>
    </tr>
    <tr>
     <td style="text-align:right;padding-right:10px;">Skills</td>
     <td><input type="text" class="fadeIn second" name="skills" /></td>
    </tr>
    <tr>
    ...
    <tr>
     ...
     <td><input type="text" class="fadeIn second" name="phone" /></td>
      ...
      <input type="submit" class="fadeIn third" value="Add employee">
    </form>
