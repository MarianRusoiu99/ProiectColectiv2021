...
<ul>
  ...
  <li style="border-bottom: 1px solid #555;"><a href="#taskuri">Taskuri</a></li>
  ...
  <li style="border-bottom: 1px solid #555;"><a class="active" href="#date_de_contact">Date de contact</a></li>
